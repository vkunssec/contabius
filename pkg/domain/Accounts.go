...
type Accounts struct {
	Id        string    `json:"id" bson:"_id,omitempty" example:"678079f6f5080a39a8eedc1e"`                      // ID da conta
	Account   string    `json:"account" bson:"account,omitempty" example:"Conta Corrente"`                       // Nome da conta
	Color     string    `json:"color" bson:"color,omitempty" example:"#000000"`                                  // Cor da conta
